...
```{r}
embed_slide("https://www.rstudio.com/wp-content/uploads/2016/11/ggplot2-cheatsheet-2.1.pdf")
```

pdfリンクを埋め込んでいます。ブラウザによっては表示されないかも知れません。リンク先は[こちら](https://www.rstudio.com/wp-content/uploads/2016/11/ggplot2-cheatsheet-2.1.pdf)です。
